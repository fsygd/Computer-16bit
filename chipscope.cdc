...
Project.filter<0>=*reg0010*
Project.filter<10>=*Destval*
Project.filter<11>=*reg*
Project.filter<12>=*reg'*
Project.filter<13>=*ram2*
Project.filter<14>=*myIF*
Project.filter<15>=*instructions*
Project.filter<16>=*Instruction*
Project.filter<17>=*myDECODE*
Project.filter<18>=myDECODE
Project.filter<1>=*reg0001*
Project.filter<2>=
Project.filter<3>=*reg0100*
Project.filter<4>=*instruction*
Project.filter<5>=*pc*
Project.filter<6>=*Ram2WE*
Project.filter<7>=*Write*
Project.filter<8>=*MemWrite*
